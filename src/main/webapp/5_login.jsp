...
<body>
	<div class="container regForm">
		...
		<form action="5_loginProc.jsp" method="post" onsubmit = "return checkValues()">
			...
			<div class="form-floating">
				<input type="password" class="form-control" name="password" id="floatingPassword" placeholder="패스워드 입력">
					<span></span>
			...
			<div class="centerDiv">
				...
				<!--  form 안에서는 type="submit" 생략 가능 / 기본값이 submit으로 동작함 -->
			</div>
		</form>
		<hr />
	</div>
	...
	console.log(fail)
	if(fail === 'y')
		document.getElementById('fail').innerHTML = '사용자의 아이디 또는 패스워드 정보가 올바르지 않습니다.'
	</script>
	<script
